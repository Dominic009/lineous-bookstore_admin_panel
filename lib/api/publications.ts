...
> => {
  const response =
    await apiClient.get<ApiResponse<Publication[]>>("/publications");
...
export const getPublication = async (
  ...
  const response = await apiClient.get<ApiResponse<Publication>>(
    `/publications/${id}`,
  );
  return response.data;
};
...
export const updatePublication = async (
  ...
  const response = await apiClient.patch<ApiResponse<Publication>>(
    `/publications/${id}`,
    dto,
  );
  return response.data;
